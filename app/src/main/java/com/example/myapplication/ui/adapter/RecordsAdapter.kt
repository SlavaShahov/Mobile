...
class RecordsAdapter : ListAdapter<ScoreRecord, RecordsAdapter.RecordViewHolder>(DiffCallback) {
    ...
    private var records: List<ScoreRecord> = emptyList()

    fun updateRecords(newRecords: List<ScoreRecord>) {
    ...
    override fun onBindViewHolder(holder: RecordViewHolder, position: Int) {
        ...
        Log.d("RecordsAdapter", "Binding position: $displayPosition, score: ${record.score}")
        holder.bind(record, displayPosition)
    }
